...
public class ChannelEchoServer2 {
    ...
    public void run() {
        ...
        try {
            ...
            while (true) {
                ...
                ChannelEchoThread cethread=new ChannelEchoThread(channel,this);
                new Thread(cethread).start();
    ...
    class ChannelEchoThread implements Runnable {
        ...
        ChannelEchoServer2 server;

        public ChannelEchoThread(SocketChannel channel,ChannelEchoServer2 server) {
